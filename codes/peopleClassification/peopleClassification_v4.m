...
clc;
close all;
disp('Dual Bayesian logistic regression model');

% Open file
fileID = fopen('dblr.txt','w');
% Define color space
colorSpace = cell(5,1);
colorSpace{1} = 'RGB';
colorSpace{2} = 'Gray';
...
for varVal = [.001,.01,.1,1,10,100]
    ...
    avg_false_alarm = 0;
        ...
        for i = 1:CVO.NumTestSets
            ...
            [predictions,psi] = fit_dblogr (X_k, w_k, var_prior, X_test_k, initial_psi, 1);
